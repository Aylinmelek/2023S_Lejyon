...
public class FortifyTest {
    public static void main(String[] args) {
        ...
        conkueror.fortify(player1, territory2, territory1, 2); // If army count of a territory is = 0
        System.out.println("2:");
        conkueror.fortify(player1, territory1, territory3, 2); // If territoryTo is not adjacent of TerritoryFrom
        System.out.println("3:");
        conkueror.fortify(player1, territory1, territory4, 2); // If Player doesn't own territoryTo
        System.out.println("4:");
        conkueror.fortify(player1, territory1, territory4, 2); // If Player doesn't own territoryFrom
